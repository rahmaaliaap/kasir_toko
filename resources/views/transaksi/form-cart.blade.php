...
<script>
    ...
    const inputField = `<input type="number" id="quantity-${hash}" class="form-control input-quantity" value="${quantity}" oninput="updateQuantity('${hash}', this.value)">`;

    let btn = `<button type="button" class="btn btn-xs btn-success mr-2" onclick="changeQuantity('${hash}', ${quantity + 1})">
        <i class="fas fa-plus"></i>
        </button>`;

    btn += `<button type="button" class="btn btn-xs btn-primary mr-2" onclick="changeQuantity('${hash}', ${quantity - 1})">
...
function updateQuantity(hash, quantity) {
    $.ajax({
        type: "PUT",
        url: "/cart/" + hash,
        data: {
...
function changeQuantity(hash, newQuantity) {
    $.ajax({
        type: "PUT",
        url: "/cart/" + hash,
        data: {
